...
namespace BlazorDemos.Shared
{
    ...
    public class DynamicResourceLoader : ComponentBase
    {
        ...
        private readonly Dictionary<string, ComponentSamplesResources> CompSamplesResourcesMappings = new()
        {
            ...
            {"document-editor", new() { CssDirectory= "document-editor", JsFiles= new[] {"syncfusion-blazor-documenteditor","sf-grid", "sf-dialog","sf-multiselect","sf-treeview","sf-spinner" } } },
            {"ai-documenteditor", new() { CssDirectory= "ai-documenteditor", JsFiles= new[] {"syncfusion-blazor-documenteditor","sf-ai-assistview","sf-spinner", "sf-toast"} } }
        };
        ...
        private string GetResourcesMarkup(bool isAddScript)
        {
            ...
            var cdnStylePath = "https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/";
            ...
            else 
            {
                if(theme != "fluent2")
                {
                    sb.AppendLine($"<link rel=\"stylesheet\" href=\"https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/demo-page-comps/{theme}.min.css\" />");
                }
                ...
                {
                    sb.AppendLine($"<link rel=\"stylesheet\" href=\"https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/highcontrast.min.css\" />");
                    sb.AppendLine($"<link rel=\"stylesheet\" href=\"https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/dark-theme.min.css\" />");
                }
