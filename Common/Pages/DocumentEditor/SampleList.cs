    ...
    internal partial class SampleConfig
    {
        public List<Sample> DocumentEditor { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                Type = SampleType.New,
                Directory = "DocumentEditor/DocumentEditor",
                MetaTitle = "Blazor Document Editor Spell Checking - Syncfusion Demos",
                HeaderText = "Blazor Document Editor Example - Spell Checking",
                MetaDescription = "This example demonstrates the built-in spell checker functionality in the Document Editor component with real-time error detection and suggestions.",
                Url = "document-editor/spellcheck",
                FileName = "SpellCheck.razor",
                NotificationDescription = new string[]{ @"This demo showcases the built-in spell-checking feature in the DOCX Editor. It automatically highlights spelling errors, allows users to enable or disable spell checking, and provides options for underline styles and suggestion visibility to improve document accuracy." }
            },
            new Sample
            {
