...
const homepagepath = ["/word/demos/", "/development/word/net10/demos/", "/release/word/net10/demos/", "/hotfix/word/net10/demos/", "/"];
    ...
    dynamicResources: function () {
        if (data.configuration == "Release") {
            ...
            if (window.location.href.indexOf('dark') != -1 || window.location.href.indexOf('fluent2-highcontrast') != -1 || window.location.href.indexOf('highcontrast') != -1) {
                loadAssets("https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/highcontrast.min.css");
                loadAssets("https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/dark-theme.min.css");
            }
        }
        else {
...
function homePageAssets() {
    ...
    if (data.configuration == "Release") {
        assetFiles = [
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/home-page/fluent2.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/bootstrap.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/favicon.ico',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/site.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/home.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/devices.min.css'
        ];
    }
...
function samplePageAssets() {
    ...
    if (data.configuration == "Release") {
        assetFiles = [
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/favicon.ico',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/bootstrap.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/roboto.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/highlight.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/demos.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/styles/32.1.19/common/devices.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/docx-editor/scripts/32.1.19/highlight.min.js'
        ];
    }
    else if (data.configuration == "Staging") {
        assetFiles = [
